    ...
    try:
        ...
        for a_cho in chos:
            ...
            if len(tifs) > 1:
                ...
                filler_list = tifs
            for a_file in filler_list:
                label_string = a_file.split('.')[0].split('-')[-1]
                a_canvas = {}
                the_img = a_file
                try:
                    f = open(the_img, "rb")
                    ...
                    the_info = magic.from_file(a_file).split(',')
                ...
                a_canvas["label"] = label_string + " Quadrant of Map"
                a_canvas["images"] = []
                an_img = {}
                ...
                an_img["resource"] = {}
                tif_id = a_file.split("/data/voldemort/digital_collections/data/ldr_oc_admin/files/IIIF_Files/")[1]
